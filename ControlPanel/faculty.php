				...
				<table border=0 style="padding-bottom: 20px;" cellpadding="5" border="0" cellspacing="0" width="80%" height="210">
					   <tr>
						...
						<tr>
							...
							<td height="49"><b>:</b></td>
							<td height="49" width="755"><DIV id="error_name" style="color:red;"></DIV><br><input name="name" type="text" class="form-control" id="txtName"   /></td>
							<td width="0" valign="top" height="49"></td>		
						</tr>
						...
						<tr>
							...
							<td height="41"><b>:</b></td>
							<td height="41" width="755"><br><DIV id="error_designation" style="color:red;"></DIV><input name="designation" type="text"  class="form-control" id="txtDesignation"  /></td>
							<td width="0" valign="top" height="41"></td>		
						</tr>
						...
						<tr>
							...
							<td height="41"><b>:</b></td>
							<td height="41" width="755"><br><DIV id="error_qualification" style="color:red;"></DIV><input type="text" size="12" id="qualification" class="form-control" style="width:150px;" name="qualification"/></td>
							<td width="0" valign="top" height="41"></td>		
						</tr>
						...
						<tr>
							...
							<td><b>:</b></td>
							<td width="755"><DIV id="error_photo" style="color:red;"></DIV><br><input name="photo" type="file" id="photo" onchange="return CheckPhotoExt();" /><br></td>
